...
class RequestHandler {
    ...
    ratelimits = {};
    readyQueue = [];
    userAgent = `DiscordBot (https://github.com/teamnetris/netris, ${require("../../package.json").version})`;
    ...
    * @arg {Object | Array<Object>} [file] File object or an array of them
    * @arg {Buffer} file.file A buffer containing file data
    * @arg {String} file.name What to name the file
    * @arg {String} file.fieldName The multipart body field name
