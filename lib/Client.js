...
/**
* Represents the main Netris client
...
class Client extends EventEmitter {
    ...
    * @arg {Object} options Netris client options
    ...
    * @arg {Boolean} [options.gateway.autoreconnect=true] Have Netris autoreconnect when connection is lost
    ...
    * @arg {Number | Array<String | Number>} [options.gateway.intents] A list of [intent names](https://github.com/projectNetris/Netris/blob/dev/lib/Constants.js#L311), pre-shifted intent numbers to add, or a raw bitmask value describing the intents to subscribe to. Some intents, like `guildPresences` and `guildMembers`, must be enabled on your application's page to be used. By default, all non-privileged intents are enabled.
    ...
    * @arg {Number | String} [options.gateway.maxConcurrency=1] The number of shards that can start simultaneously. If "auto" Netris will use Discord's recommended shard concurrency.
    * @arg {Number | String} [options.gateway.maxShards=1] The total number of shards you want to run. If "auto" Netris will use Discord's recommended shard count.
    ...
    * @arg {Number} [options.rest.latencyThreshold=30000] The average request latency at which Netris will start emitting latency errors
    ...
    */
    constructor(token, options) {
        ...
        /**
         * Collection of shards Netris is using
    ...
    */
    getRESTChannel(channelID) {
        if(!this.options.restMode) {
            return Promise.reject(new Error("Netris REST mode is not enabled"));
        }
